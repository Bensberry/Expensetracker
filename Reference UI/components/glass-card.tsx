...
interface GlassCardProps {
  ...
  className?: string;
  variant?: "default" | "premium" | "accent" | "glossy";
}
...
export function GlassCard({ children, className, variant = "default" }: GlassCardProps) {
  const variants = {
    ...
    glossy: "bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-xl border border-white/20 shadow-[0_4px_12px_rgba(255,255,255,0.2)]"
  };
